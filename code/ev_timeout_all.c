...
# 5 "sample/ev_timeout.c" 2




# 8 "sample/ev_timeout.c"
ev_io stdin_watcher;
...
main (void)
{
  ...
  do { do { ((ev_watcher *)(void *)((&timeout_watcher)))->active = ((ev_watcher *)(void *)((&timeout_watcher)))->pending = 0; ( (ev_watcher *)(void *)(((&timeout_watcher))))->priority = (0); ((((&timeout_watcher)))->cb = ((timeout_cb)), memmove (&((ev_watcher *)(((&timeout_watcher))))->cb, &(((&timeout_watcher)))->cb, sizeof ((((&timeout_watcher)))->cb))); } while (0); do { ((ev_watcher_time *)((&timeout_watcher)))->at = ((5.5)); ((&timeout_watcher))->repeat = ((0.)); } while (0); } while (0);
